...
GENERATIONS = 1 # Number of generations for Genetic Algorithm
POPULATION = 2  #Number of individuals
...
def main(argv):
    ...
    if trainfile:
        ...
        genome.setParams(rangemin= 1, rangemax=(TrainSet.FeaturesNum)*2)
